# 🎤 Altron — Open-Source Voice-First AI Assistant for Android

**Altron is an open-source AI assistant for Android that actually controls your phone.**
...
Altron is not just a chatbot with a microphone.
...
**Altron doesn’t stop at answering. It executes.**
...
> Altron is currently best suited for technical beta testers. Full setup may require multiple API keys and service credentials.
...
Branding and this distribution are maintained by Abbas Khan. The original open-source license, copyright notices, and upstream project attribution remain unchanged.
